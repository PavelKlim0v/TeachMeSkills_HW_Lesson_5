 ...
 *    При создании объекта "компьютер" с помощью первого констуктора должны создаваться поля RAM и HDD с помощью
...
public class main_2 {
    ...
    public static void main(String[] args) {
        ...
        Computer computer2 = new Computer(2000,"Dell-2200LX",8,500);

        // дополнительная строчка, на случай вывода полной информации
        //computer1.fullInformation();      // (если исп. этот метод, то computer2 нужно убрать)
    }
}
